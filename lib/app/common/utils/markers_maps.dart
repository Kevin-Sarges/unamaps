...
class MarkersMaps {
  final List<LocalEntity> _listLocal = [
    ...
    LocalModel(
      ...
      marker: 'assets/images/LAB.png',
      foto:
          'https://firebasestorage.googleapis.com/v0/b/imagens-85754.appspot.com/o/L-104.jpeg?alt=media&token=cc25f018-92da-4c7a-a024-77ec893a7772',
    ),
    LocalModel(
      lat: -1.4393372,
      lon: -48.4778982,
    ...
    LocalModel(
      lat: -1.4394190,
      lon: -48.4778032,
      nomeLocal: 'Banheiro M',
      tipoLocal: 'Banheiros',
      marker: 'assets/images/banheiro_M.png',
      foto:
          'https://firebasestorage.googleapis.com/v0/b/imagens-85754.appspot.com/o/Banheiro_M_1%C2%BAandar_bloco_L.jpeg?alt=media&token=a6b2a70f-6758-413b-8151-b7052907c124',
    ),
  ];

  List<LocalEntity> get locais => _listLocal;
}
